...
impl MoveGenerator {
    ...
    pub fn add_pawn_movement(move_list: &mut GameMoveList, target_square: u8, source_square_offset: i8, is_capture: bool) {
        ...
        if target_rank == 0 || target_rank == 7 {
            ...
            // self.add_move(Piece::PAWN, target_square + source_square_offset, target_square, is_capture, Piece::BISHOP);
            // self.add_move(Piece::PAWN, target_square + source_square_offset, target_square, is_capture, Piece::ROOK);
...
mod tests {
    ...
    fn test_add_pawn_movements() {
        ...
        assert_eq!(
            format!("{:?}", &move_list.move_list[0..move_list.list_len]),
            "[GameMove { piece: PAWN, source_square: \"d2\", target_square: \"d3\", promotion_piece: NONE, is_capture: true }, GameMove { piece: PAWN, source_square: \"g3\", target_square: \"g4\", promotion_piece: NONE, is_capture: true }, GameMove { piece: PAWN, source_square: \"a5\", target_square: \"a6\", promotion_piece: NONE, is_capture: true }, GameMove { piece: PAWN, source_square: \"h6\", target_square: \"h7\", promotion_piece: NONE, is_capture: true }, GameMove { piece: PAWN, source_square: \"a7\", target_square: \"a8\", promotion_piece: KNIGHT, is_capture: true }, GameMove { piece: PAWN, source_square: \"a7\", target_square: \"a8\", promotion_piece: QUEEN, is_capture: true }, GameMove { piece: PAWN, source_square: \"d7\", target_square: \"d8\", promotion_piece: KNIGHT, is_capture: true }, GameMove { piece: PAWN, source_square: \"d7\", target_square: \"d8\", promotion_piece: QUEEN, is_capture: true }]"
        );
    }
