...
mod tests {
    ...
    fn test_calc_queen_movements() {
        ...
        LegalMovesHelper::check_attack_and_movement_squares(
            Queen::calc_movements(&position, position.wq, &mut move_list, None, &mut king_attack_analyzer),
        ...
        LegalMovesHelper::check_attack_and_movement_squares(
            Queen::calc_movements(&position, position.bq, &mut move_list, None, &mut king_attack_analyzer),
